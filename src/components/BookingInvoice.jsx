...
import parklineLogo from "../assets/parkline-logo.png"
const BookingInvoice = forwardRef(( { data}, ref) => {
    ...
    >
      ...
      <div className=" text-black p-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">PARKLINE TRAVELS LIMITED</h1>
      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-xl font-bold text-gray-800">গাড়ি ভাড়ার ইনভয়েস</h2>
            <p className="text-sm text-gray-600">#INV-{Date.now().toString().slice(-6)}</p>
          </div>
          <div className="text-right text-sm">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 bg-gray-50">
          <div className=" p-3 rounded">
            <h3 className="font-semibold text-gray-800 mb-2 text-sm">গ্রাহকের তথ্য</h3>
          ...
          <div className=" p-3 rounded">
            <h3 className="font-semibold text-gray-800 mb-2 text-sm">ভাড়ার বিবরণ</h3>
            <div className="space-y-1 text-sm">
          ...
          <div className="bg-white border border-gray-200 rounded overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-3 py-2 text-left font-semibold text-gray-800">বিবরণ</th>
                  <th className="px-3 py-2 text-center font-semibold text-gray-800">সময়কাল</th>
                  <th className="px-3 py-2 text-right font-semibold text-gray-800">পরিমাণ</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-gray-200">
                  <td className="px-3 py-2">
                    <div>
                      <p className="font-medium text-gray-800">গাড়ি ভাড়া - {carName}</p>
  ...
  {(() => {
    ...
    return `${diffDays} দিন`;
                  ...
                  <td className="px-3 py-2 text-right font-semibold">৳{totalAmount?.toLocaleString()}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 text-center">
          <p className="font-semibold text-gray-800">Parkline Travels এ আপনাকে ধন্যবাদ!</p>
          <p className="text-xs text-gray-600 mt-1">যোগাযোগ: +880-2-123456789</p>
        </div>
      </div>
    </div>
  )
